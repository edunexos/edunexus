<nav x-data="{ open: false }" class="bg-white border-b-2 border-gray-100 p-2">
        ...
        <div class="flex justify-between h-[70px]">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center gap-10">
                    <button @click="close = ! close" :class="{ 'invisible absolute': !close, 'visible': close }"
                        class="hidden invisible sm:block pb-[3px]" type="button">
                        <img class="mt-1 cursor-pointer" src="{{ asset('assets/img/IconSidebar.svg') }}"
                            alt="icon sidebar">
                    </button>
                    <a href="{{ route('dashboard') }}" class="block sm:hidden">
                        <!-- <x-application-mark class="block h-9 w-auto" />-->
                        <img class="block cursor-pointer" src="{{ asset('assets/img/Logo.svg') }}" alt="logo">
                    </a>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('educational-games') }}" :active="request()->routeIs('educational-games')">
